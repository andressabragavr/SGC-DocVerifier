...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "certificado" | "issuer" | "auditLog"
    ...
    model: {
      ...
      Issuer: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.IssuerFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.IssuerAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "password" | "ra" | "curso" | "tipo", ExtArgs["result"]["user"]>
  ...
  interface UserFieldRefs {
    ...
    readonly ra: FieldRef<"User", 'String'>
  ...
  export type CertificadoMinAggregateOutputType = {
    ...
    relacaoComCurso: boolean | null
    nomeNoCertificado: string | null
  ...
  export type CertificadoCountAggregateOutputType = {
    ...
    instituicao: number
    semestre: number
    relacaoComCurso: number
    nomeNoCertificado: number
    extraidoRaw: number
    dataConclusao: number
    fileHashSHA256: number
    _all: number
  }
  ...
  export type CertificadoSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    nomeNoCertificado?: boolean
    extraidoRaw?: boolean
    dataConclusao?: boolean
    fileHashSHA256?: boolean
  ...
  export type CertificadoOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "titulo" | "tipoAtividade" | "dataEnvio" | "horasAtribuidas" | "urlPDF" | "status" | "userId" | "instituicao" | "semestre" | "relacaoComCurso" | "nomeNoCertificado" | "extraidoRaw" | "dataConclusao" | "fileHashSHA256", ExtArgs["result"]["certificado"]>
  ...
  export type $CertificadoPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    scalars: $Extensions.GetPayloadResult<{
      ...
      relacaoComCurso: boolean | null
      nomeNoCertificado: string | null
      extraidoRaw: Prisma.JsonValue | null
      dataConclusao: Date | null
      fileHashSHA256: string | null
    }, ExtArgs["result"]["certificado"]>
    composites: {}
  ...
  interface CertificadoFieldRefs {
    ...
    readonly tipoAtividade: FieldRef<"Certificado", 'String'>
    readonly dataEnvio: FieldRef<"Certificado", 'DateTime'>
    readonly horasAtribuidas: FieldRef<"Certificado", 'Int'>
    readonly urlPDF: FieldRef<"Certificado", 'String'>
    readonly status: FieldRef<"Certificado", 'CertStatus'>
    readonly userId: FieldRef<"Certificado", 'String'>
    readonly instituicao: FieldRef<"Certificado", 'String'>
    readonly semestre: FieldRef<"Certificado", 'String'>
    readonly relacaoComCurso: FieldRef<"Certificado", 'Boolean'>
    readonly nomeNoCertificado: FieldRef<"Certificado", 'String'>
    readonly extraidoRaw: FieldRef<"Certificado", 'Json'>
    readonly dataConclusao: FieldRef<"Certificado", 'DateTime'>
    readonly fileHashSHA256: FieldRef<"Certificado", 'String'>
  }
  ...
  export type IssuerOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "isTrusted" | "trustLevel" | "notes" | "updatedAt", ExtArgs["result"]["issuer"]>
  ...
  export interface IssuerDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Issuers that matches the filter.
     * @param {IssuerFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const issuer = await prisma.issuer.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: IssuerFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Issuer.
     * @param {IssuerAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const issuer = await prisma.issuer.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: IssuerAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface IssuerFieldRefs {
    ...
    readonly isTrusted: FieldRef<"Issuer", 'Boolean'>
    readonly trustLevel: FieldRef<"Issuer", 'Float'>
    readonly notes: FieldRef<"Issuer", 'String'>
   ...
   * Issuer findRaw
   */
  export type IssuerFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * Issuer aggregateRaw
   */
  export type IssuerAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type AuditLogOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "certificadoId" | "status" | "reason" | "evidence" | "stateSnap" | "createdAt", ExtArgs["result"]["auditLog"]>
  ...
  export type $AuditLogPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    scalars: $Extensions.GetPayloadResult<{
      ...
      stateSnap: Prisma.JsonValue | null
      createdAt: Date
    }, ExtArgs["result"]["auditLog"]>
    composites: {}
  }
  ...
  interface AuditLogFieldRefs {
    ...
    readonly certificadoId: FieldRef<"AuditLog", 'String'>
    readonly status: FieldRef<"AuditLog", 'CertStatus'>
    readonly reason: FieldRef<"AuditLog", 'String'>
    readonly evidence: FieldRef<"AuditLog", 'Json'>
    readonly stateSnap: FieldRef<"AuditLog", 'Json'>
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    ra?: StringWithAggregatesFilter<"User"> | string
  ...
  export type CertificadoWhereInput = {
    ...
    tipoAtividade?: StringFilter<"Certificado"> | string
    dataEnvio?: DateTimeFilter<"Certificado"> | Date | string
    horasAtribuidas?: IntFilter<"Certificado"> | number
    urlPDF?: StringFilter<"Certificado"> | string
    status?: EnumCertStatusFilter<"Certificado"> | $Enums.CertStatus
    userId?: StringFilter<"Certificado"> | string
    instituicao?: StringNullableFilter<"Certificado"> | string | null
    semestre?: StringNullableFilter<"Certificado"> | string | null
    relacaoComCurso?: BoolNullableFilter<"Certificado"> | boolean | null
    nomeNoCertificado?: StringNullableFilter<"Certificado"> | string | null
    extraidoRaw?: JsonNullableFilter<"Certificado">
    dataConclusao?: DateTimeNullableFilter<"Certificado"> | Date | string | null
    fileHashSHA256?: StringNullableFilter<"Certificado"> | string | null
  ...
  export type CertificadoOrderByWithRelationInput = {
    ...
    dataEnvio?: SortOrder
    horasAtribuidas?: SortOrder
    urlPDF?: SortOrder
    status?: SortOrder
    userId?: SortOrder
    instituicao?: SortOrder
    semestre?: SortOrder
    relacaoComCurso?: SortOrder
    nomeNoCertificado?: SortOrder
    extraidoRaw?: SortOrder
    dataConclusao?: SortOrder
    fileHashSHA256?: SortOrder
  ...
  export type CertificadoScalarWhereWithAggregatesInput = {
    ...
    tipoAtividade?: StringWithAggregatesFilter<"Certificado"> | string
    dataEnvio?: DateTimeWithAggregatesFilter<"Certificado"> | Date | string
    horasAtribuidas?: IntWithAggregatesFilter<"Certificado"> | number
    urlPDF?: StringWithAggregatesFilter<"Certificado"> | string
    status?: EnumCertStatusWithAggregatesFilter<"Certificado"> | $Enums.CertStatus
    userId?: StringWithAggregatesFilter<"Certificado"> | string
    instituicao?: StringNullableWithAggregatesFilter<"Certificado"> | string | null
    semestre?: StringNullableWithAggregatesFilter<"Certificado"> | string | null
    relacaoComCurso?: BoolNullableWithAggregatesFilter<"Certificado"> | boolean | null
    nomeNoCertificado?: StringNullableWithAggregatesFilter<"Certificado"> | string | null
    extraidoRaw?: JsonNullableWithAggregatesFilter<"Certificado">
    dataConclusao?: DateTimeNullableWithAggregatesFilter<"Certificado"> | Date | string | null
    fileHashSHA256?: StringNullableWithAggregatesFilter<"Certificado"> | string | null
  }
  ...
  export type IssuerWhereInput = {
    ...
    isTrusted?: BoolFilter<"Issuer"> | boolean
    trustLevel?: FloatFilter<"Issuer"> | number
    notes?: StringNullableFilter<"Issuer"> | string | null
  ...
  export type IssuerScalarWhereWithAggregatesInput = {
    ...
    isTrusted?: BoolWithAggregatesFilter<"Issuer"> | boolean
    trustLevel?: FloatWithAggregatesFilter<"Issuer"> | number
    notes?: StringNullableWithAggregatesFilter<"Issuer"> | string | null
  ...
  export type AuditLogWhereInput = {
    ...
    certificadoId?: StringFilter<"AuditLog"> | string
    status?: EnumCertStatusFilter<"AuditLog"> | $Enums.CertStatus
    reason?: StringFilter<"AuditLog"> | string
    evidence?: JsonFilter<"AuditLog">
    stateSnap?: JsonNullableFilter<"AuditLog">
    createdAt?: DateTimeFilter<"AuditLog"> | Date | string
  }

  export type AuditLogOrderByWithRelationInput = {
    id?: SortOrder
    certificadoId?: SortOrder
    status?: SortOrder
    reason?: SortOrder
    evidence?: SortOrder
    stateSnap?: SortOrder
  ...
  export type AuditLogScalarWhereWithAggregatesInput = {
    ...
    certificadoId?: StringWithAggregatesFilter<"AuditLog"> | string
    status?: EnumCertStatusWithAggregatesFilter<"AuditLog"> | $Enums.CertStatus
    reason?: StringWithAggregatesFilter<"AuditLog"> | string
    evidence?: JsonWithAggregatesFilter<"AuditLog">
    stateSnap?: JsonNullableWithAggregatesFilter<"AuditLog">
  ...
  export type CertificadoCreateInput = {
    ...
    relacaoComCurso?: boolean | null
    nomeNoCertificado?: string | null
    extraidoRaw?: InputJsonValue | null
  ...
  export type CertificadoUpdateInput = {
    ...
    horasAtribuidas?: IntFieldUpdateOperationsInput | number
    urlPDF?: StringFieldUpdateOperationsInput | string
    status?: EnumCertStatusFieldUpdateOperationsInput | $Enums.CertStatus
    instituicao?: NullableStringFieldUpdateOperationsInput | string | null
    semestre?: NullableStringFieldUpdateOperationsInput | string | null
    relacaoComCurso?: NullableBoolFieldUpdateOperationsInput | boolean | null
    nomeNoCertificado?: NullableStringFieldUpdateOperationsInput | string | null
    extraidoRaw?: InputJsonValue | InputJsonValue | null
    dataConclusao?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    fileHashSHA256?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type AuditLogUpdateInput = {
    certificadoId?: StringFieldUpdateOperationsInput | string
    status?: EnumCertStatusFieldUpdateOperationsInput | $Enums.CertStatus
    reason?: StringFieldUpdateOperationsInput | string
    evidence?: InputJsonValue | InputJsonValue
    stateSnap?: InputJsonValue | InputJsonValue | null
